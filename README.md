...
1.	أنشئ قاعدة بيانات shop_db في MySQL.
2.	استورد 111/11/shop_db.sql.
3.	عدّل الاتصال في 111/11/components/connect.php (host/db/user/pass).
4.	Composer install داخل مجلد 111/11/ لتثبيت PHPMailer:
o	(لو مش متاح Composer عندك، نزّل مجلد vendor يدوياً أو غيّر mail.php لاستخدام نسخة PHPMailer مضمنة).
5.	حدّث إعدادات mail.php (SMTP) وuser_login.php (مفاتيح reCAPTCHA).
6.	ضع المشروع تحت localhost (XAMPP/WAMP)، وافتح http://localhost/111/11/home.php.
7.	ادخل لوحة الإدارة: http://localhost/111/11/admin/admin_login.php (أنشئ إدمن من register_admin.php لو لزم).
